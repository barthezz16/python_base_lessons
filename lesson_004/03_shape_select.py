...
# тут я понимаю, что должен быть словарь с функциями, и они должны соответствовать выбору пользователя
# как потом заставить это работать как надо, не совсем понимаю
# TODO Удобнее было бы работать со связкой число + список
# TODO Но раз вы создали словарь - можно и с ним.
# TODO Тогда от пользователя нам надо получить один из ключей словаря
# TODO Проверить это можно простым условие if user_input in словарь
# TODO Если да - то мы создаем переменную, в которую надо будет достать функцию из словаря.
# TODO Функция сама по себе - тоже является объектом. Как мы раньше доставали из словаря числа, так достанем функцию
# TODO переменная = словарь[user_input]
# TODO После этого переменная будет содержать в себе функцию
# TODO И нам остается только заставить его сработать, сделать это можно добавив к переменной скобки и параметры
# TODO переменная(параметры)
# TODO Такая запись будет идентична обычному вызову функции, например triangle(параметры)
# TODO Только функция будет меняться в зависимости от выбора пользователя
