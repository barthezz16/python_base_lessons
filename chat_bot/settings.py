    ...
    'registration': {
        ...
        'steps': {
            ...
            'step2.1': {
                ...
                # TODO 1) Сложный путь: Можно в случае ошибки вызвать отдельный шаг, для которого будет написан
                # TODO Свой handler. Для этого надо будет добавить в словари ещё один ключ правда
                # TODO Но это позволит расширить функционал.
                # TODO 2) Попроще: можно при вызове handler_city_departure, записать в context нужную информацию
                # TODO по отдельному ключу и тут использовать этот ключ для распечатывания информации
