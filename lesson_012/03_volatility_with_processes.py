...
if __name__ == '__main__':
    ...
    def get_file():
        ...
        # TODO collector.get() я видел что там есть все мои данные, и так же пробовал разными способами распакововвать
        # TODO данне в переменные, проблемы у меня появилась в том, что я так и не понял как можно эти данные передать
        # TODO в функцию sort_and_print() там же обрабатывается self.total и как мне в туда передать данные не именяя
        # TODO тот код в Utils. Или можно просто тут вывести все принты.
