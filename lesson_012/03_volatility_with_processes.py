...
if __name__ == '__main__':
    ...
    # TODO Максим, сори, может я опять плохо сформулировал свой вопрос, я попробовал разные способы с
    # TODO collector.get() я видел что там есть все мои данные и понял как получить значения и так же пробовал
    # TODO разными способами распакововвать данне в переменные, проблемы у меня появилась в том, что я так и не понял
    # TODO как можно эти данные передать в функцию sort_and_print() там же обрабатывается self.total и как мне в туда
    # TODO передать данные не именяя тот код в Utils. Или можно просто тут вывести все принты.
